...
bool UpdateFramework()
{
	...
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::W))
		lastKeyPressed = EKeyPressed::ePlaceWall;
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::E))
		lastKeyPressed = EKeyPressed::ePlaceEmpty;
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::G))
		lastKeyPressed = EKeyPressed::ePlaceGoal;
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::F))
		lastKeyPressed = EKeyPressed::ePlaceFire;
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::P))
		lastKeyPressed = EKeyPressed::ePlacePlayer;
